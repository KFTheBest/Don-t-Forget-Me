                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(!(task.isSuccessful()) && task.getException() instanceof FirebaseAuthUserCollisionException){
                                ...
                                if (exception.getErrorCode() == "ERROR_ACCOUNT_EXISTS_WITH_DIFFERENT_CREDENTIAL") {

                                    Toast.makeText(LoginActivity.this, "Account in use with different login provider. Please log in with that" +
                                                    "and link your account within the app!",
